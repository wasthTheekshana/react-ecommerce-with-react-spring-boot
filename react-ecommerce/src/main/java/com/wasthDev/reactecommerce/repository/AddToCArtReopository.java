...
public interface AddToCArtReopository extends JpaRepository<AddToCart,Long> {
    ...
    @Query("Select addCart  FROM AddToCart addCart WHERE addCart.products.id= :product_id and addCart.user_id=:user_id")
